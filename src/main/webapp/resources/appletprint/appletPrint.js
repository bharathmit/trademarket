	...
	*/
	function deployQZ() {
		...
		var attributes = {id: "qz", code:'qz.PrintApplet.class', 
			archive:'http://localhost:8080/trademarket/resources/appletprint/qz-print.jar', width:1, height:1};
		var parameters = {jnlp_href: 'resources/appletprint/qz-print_jnlp.jnlp', 
